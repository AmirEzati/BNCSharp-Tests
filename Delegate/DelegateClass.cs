   ...
   public class DelegateClass
    {
        ...
        {
            Console.WriteLine("Welcome to the Test Delegates. Enter a key to continue");
            Console.WriteLine("Enter 1)Simple Delegates  2)AnonymousMethods 3)MultiCastDelegate  ");
